...
BlackChain Node is offered under a dual-license model.

### Open-source option

Unless you have a separate commercial agreement with BlackChain Labs LLC, this repository is available under the GNU Affero General Public License v3.0 or any later version. See `LICENSE` for the full text.

### Commercial option

BlackChain Labs LLC also offers separate commercial licensing for organizations that want to embed, white-label, commercially deploy, or operate proprietary derivatives, managed services, OEM distributions, or other non-AGPL uses. See `COMMERCIAL_LICENSE.md`.

### Trademark notice

No right to use the BlackChain, BlackChain Node, Node, or Node™ names, logos, trade dress, or other brand assets is granted by the AGPL or by access to this repository. See `TRADEMARK_POLICY.md`.

### Transition note

Future development in this repository is governed by the licensing structure above unless explicitly stated otherwise in a specific file or written agreement.
